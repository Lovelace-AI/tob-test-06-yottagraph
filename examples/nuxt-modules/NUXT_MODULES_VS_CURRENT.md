...
moduleRegistry.register(eventSender); // Must be first if others depend on it
moduleRegistry.register(entityLookup); // Order matters!
```
...
export default defineNuxtConfig({
    modules: [
        '@your-org/event-sender', // ✅ Auto-registered first
        '@your-org/entity-lookup', // ✅ Auto-registered second
